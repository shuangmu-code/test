<template>
   <div class="manual-bill">
       <div>
            <div class="manual-bill-title">二维码开票</div>
                ...
                <div class="manual-bill-body-center">
                                ...
                                <el-form :model="formMessage">
                                    <el-row class="basic-information-top-row">
                                        ...
                                        <el-col :span="18" class="last-col"> 
                                            <input v-model="formMessage.applicantName" class="QRtop-input-style" disabled/>
                                        </el-col>
                                    </el-row>
                                    <el-row class="basic-information-top-row">
                                        <el-col :span="6">
                                        ...
                                        <el-col :span="18" class="last-col">
                                            <input v-model="formMessage.applicantIdentifier" class="QRtop-input-style" disabled/>
                                        </el-col>
                                    </el-row>
                                    <el-row class="basic-information-top-row">
                                        <el-col :span="6">
                                        ...
                                        <el-col :span="11">
                                            <input v-model="formMessage.applicantAddrress" class="QRtop-input-style" disabled/>
                                        </el-col>
                                        <el-col :span="6" class="last-col">
                                            <input v-model="formMessage.applicantCompanyTel" class="QRtop-input-style" style="margin-left:20px" disabled/>
                                        </el-col>
                                    </el-row>
                                    <el-row class="basic-information-top-row">
                                        <el-col :span="6">
                                        ...
                                        <el-col :span="11">
                                            <input v-model="formMessage.applicantAccountBank" class="QRtop-input-style" disabled/>
                                        </el-col>
                                        <el-col :span="6" class="last-col">
                                            <input v-model="formMessage.applicantAccountNum" class="QRtop-input-style" style="margin-left:20px" disabled/>
                                        </el-col>
                                    </el-row>
                                </el-form>
                            </td>
                        ...
                        <table class="manual-bill-table-detail" id="table-detail">
                            ...
                            <tr class="table-detail-style-tr2" v-for="(item,index) in total_details" :key="index">
                                ...
                                <td class="detail-label-style" style="border:1px solid #8C8C8C;" >
                                    ...
                                    <!-- <span class="detail-input-style" style="color:black">{{item.Taxrate | TaxFormat}}</span> -->
                                </td>
                                <td class="detail-label-style" style="border:1px solid #8C8C8C;">
                    ...
                    <div class="manual-bill-table-bottom-label">
                        <el-row>
                            ...
                            <el-col :span="4">
                                <input v-model="formMessage.chamberlain" class="QRtop-input-style" disabled/>
                            </el-col>
                            <el-col :span="2">
                                <div class="top-label-style">复核：</div>
                            </el-col>
                            <el-col :span="4">
                                <input v-model="formMessage.review" class="QRtop-input-style" disabled/>
                            </el-col>
                            <el-col :span="2">
                                <div class="top-label-style">开票人：</div>
                            </el-col>
                            <el-col :span="4">
                                <input v-model="formMessage.issuer" class="QRtop-input-style" disabled/>
                            </el-col>
                            <el-col :span="3">
                                <div class="top-label-style">销售方：(章)</div>
                            </el-col>
                            <el-col :span="3">
                                <input class="QRtop-input-style" style="border-bottom:0" disabled/>
                            </el-col>
                        </el-row>
                    </div>
                </div>   
